...
export const DrawerPersonalizado = () => {
  return (
    ...
    >
      <Drawer.Screen name="Pantalla1Screen" component={Pantalla1Screen} options={{ title: 'Inicio' }} />
      <Drawer.Screen name="Pantalla2Screen" component={Pantalla2Screen} options={{ title: 'Calculadora' }} />
    </Drawer.Navigator>
  );
};
...
const MenuContenido = (props: DrawerContentComponentProps) => {
  ...
  const menuItems = [
    { name: 'Pantalla1Screen', label: 'Bienvenid@s' },
    { name: 'Pantalla2Screen', label: 'Calculadora' }
  ];
    ...
    <DrawerContentScrollView style={{ backgroundColor: colores.blanco }}>
      <View style={styles.menuHeader}>
        <Image
          ...
          style={styles.avatar}
        />
        <Text style={styles.headerSubtitle}>Actividad Autónoma</Text>
      </View>
